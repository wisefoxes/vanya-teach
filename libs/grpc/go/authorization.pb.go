...
type GoogleOAuthRequest struct {
	...
	AuthJWT string `protobuf:"bytes,1,opt,name=authJWT,proto3" json:"authJWT,omitempty"`
}
...
func (x *GoogleOAuthRequest) GetAuthJWT() string {
	if x != nil {
		return x.AuthJWT
	}
	return ""
...
var file_authorization_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x2f, 0x67, 0x6f, 0x3b, 0x61, 0x75, 0x74,
...
var file_authorization_proto_goTypes = []interface{}{
	(*GoogleOAuthRequest)(nil),  // 0: authorization.GoogleOAuthRequest
	(*GoogleOAuthResponse)(nil), // 1: authorization.GoogleOAuthResponse
}
var file_authorization_proto_depIdxs = []int32{
	0, // 0: authorization.Authorization.GoogleOAuth:input_type -> authorization.GoogleOAuthRequest
	1, // 1: authorization.Authorization.GoogleOAuth:output_type -> authorization.GoogleOAuthResponse
...
func file_authorization_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authorization_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GoogleOAuthRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_authorization_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GoogleOAuthResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
func (c *authorizationClient) GoogleOAuth(ctx context.Context, in *GoogleOAuthRequest, opts ...grpc.CallOption) (*GoogleOAuthResponse, error) {
	out := new(GoogleOAuthResponse)
	err := c.cc.Invoke(ctx, "/authorization.Authorization/GoogleOAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAuthorizationServer) GoogleOAuth(context.Context, *GoogleOAuthRequest) (*GoogleOAuthResponse, error) {
...
func _Authorization_GoogleOAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoogleOAuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationServer).GoogleOAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authorization.Authorization/GoogleOAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).GoogleOAuth(ctx, req.(*GoogleOAuthRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Authorization_GoogleOAuth_Handler,
		},
	},
